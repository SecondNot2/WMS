  ...
  return (
    <div className="p-5 space-y-4">
      <div className="flex items-center justify-between mb-6">
        <div>
          <h1 className="text-xl font-bold text-text-primary">Đơn vị nhận hàng</h1>
          <p className="text-xs text-text-secondary mt-0.5">Quản lý các kho bãi và đại lý nhận hàng</p>
        </div>
      ...
      <div className="bg-card-white rounded-xl border border-border-ui shadow-sm p-20 flex flex-col items-center justify-center text-center">
        <div className="w-16 h-16 rounded-full bg-background-app flex items-center justify-center mb-4">
          <Building className="w-8 h-8 text-text-secondary" />
        </div>
        <h3 className="text-sm font-semibold text-text-primary mb-1">Chưa có đơn vị nhận hàng</h3>
        <p className="text-xs text-text-secondary">Danh sách các điểm nhận hàng sẽ hiển thị tại đây</p>
      </div>
    </div>
  );
}
