  ...
  return (
    <div className="w-full space-y-6">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <button
          onClick={() => router.back()}
          className="flex items-center gap-2 px-4 py-2 bg-white border border-border-ui rounded-lg text-text-primary hover:bg-background-app transition-colors font-medium text-sm w-fit shadow-sm"
        >
        ...
        <div className="bg-white rounded-xl border border-border-ui shadow-sm overflow-hidden">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="space-y-2">
                  ...
                  <input
                    ...
                    className={cn(
                      "w-full px-4 py-2.5 text-sm bg-white border rounded-lg outline-none focus:border-accent transition-all",
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative group">
                    <select
                      {...register("parentId")}
                      className="w-full px-4 py-2.5 text-sm bg-white border border-border-ui rounded-lg outline-none focus:border-accent transition-all appearance-none cursor-pointer"
                    >
                ...
                <div className="md:col-span-3 space-y-2">
                  ...
                  <textarea
                    ...
                    className="w-full px-4 py-3 text-sm bg-white border border-border-ui rounded-lg outline-none focus:border-accent transition-all resize-none"
                  />
                </div>
              </div>
            </div>
                ...
                {previewImage ? (
                  <div className="relative w-full aspect-video rounded-xl overflow-hidden border border-border-ui group shadow-sm">
                    ...
                    <div className="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center gap-3">
                      <label className="p-2 bg-white rounded-full text-text-primary hover:text-accent cursor-pointer shadow-lg transition-transform hover:scale-110">
                      ...
                      <button
                        type="button"
                        onClick={removeImage}
                        className="p-2 bg-white rounded-full text-text-primary hover:text-danger shadow-lg transition-transform hover:scale-110"
                      >
                        <X className="w-5 h-5" />
                      </button>
                    </div>
                  ...
                  <label className="flex flex-col items-center justify-center w-80 h-48 border-2 border-dashed border-border-ui rounded-xl bg-background-app/50 hover:bg-background-app hover:border-accent/50 transition-all cursor-pointer group">
                    ...
                    <span className="px-4 py-1.5 bg-white border border-border-ui rounded-lg text-xs font-bold text-accent shadow-sm group-hover:bg-accent group-hover:text-white transition-all">
                      Chọn ảnh
                    </span>
                    <input
                      type="file"
          ...
          <div className="px-8 py-6 bg-background-app/30 border-t border-border-ui flex items-center justify-end gap-3">
            <button
              type="button"
              onClick={() => router.back()}
              className="px-8 py-2.5 bg-white border border-border-ui rounded-lg text-sm font-bold text-text-secondary hover:bg-background-app transition-colors"
            >
              Hủy
            </button>
            <button
