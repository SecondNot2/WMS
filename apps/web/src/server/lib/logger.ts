...
export const logger = {
  debug: (...args: unknown[]) =>
    shouldLog("debug") && console.debug(format("debug", args)),
  http: (...args: unknown[]) =>
    shouldLog("http") && console.log(format("http", args)),
  info: (...args: unknown[]) =>
    shouldLog("info") && console.log(format("info", args)),
  warn: (...args: unknown[]) =>
    shouldLog("warn") && console.warn(format("warn", args)),
  error: (...args: unknown[]) =>
    shouldLog("error") && console.error(format("error", args)),
};
