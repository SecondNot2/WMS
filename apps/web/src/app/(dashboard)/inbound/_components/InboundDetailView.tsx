...
export function InboundDetailView({ id }: InboundDetailViewProps) {
  ...
  const currentStatus =
    STATUS_CONFIG[mockReceipt.status as keyof typeof STATUS_CONFIG];
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <p className="text-sm font-bold text-text-primary">
              Mã phiếu: {mockReceipt.code}
            </p>
            <p className="text-[11px] text-text-secondary">
              Ngày tạo: {mockReceipt.createdAt}
            </p>
          </div>
        </div>
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm font-bold text-text-primary">
                      {mockReceipt.supplier.name}
                    </p>
                    <p className="text-[12px] text-text-secondary mt-1">
                      {mockReceipt.supplier.address}
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <tr>
                    ...
                    <td className="px-6 py-5 text-lg text-accent text-right border-t border-border-ui tracking-tight">
                      {new Intl.NumberFormat("vi-VN", {
                        style: "currency",
                        currency: "VND",
                      }).format(mockReceipt.totalAmount)}
                    </td>
                  </tr>
                </tfoot>
              </table>
          ...
          <div className="bg-card-white rounded-xl border border-border-ui shadow-sm p-6">
            ...
            <div className="space-y-6">
              <div className="flex items-center gap-4">
                <img
                  src={mockReceipt.createdBy.avatar}
                ...
                <div>
                  ...
                  <p className="text-sm font-bold text-text-primary">
                    {mockReceipt.createdBy.name}
                  </p>
                  <p className="text-xs text-text-secondary">
                    {mockReceipt.createdBy.role}
                  </p>
                </div>
              </div>
