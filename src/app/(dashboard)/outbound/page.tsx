  ...
  return (
    <div className="p-5 space-y-4">
      <div className="flex items-center justify-between mb-6">
        <div>
          <h1 className="text-xl font-bold text-text-primary">Xuất kho</h1>
          <p className="text-xs text-text-secondary mt-0.5">Quản lý phiếu xuất và đơn vị nhận hàng</p>
        </div>
      ...
      <div className="bg-card-white rounded-xl border border-border-ui shadow-sm p-20 flex flex-col items-center justify-center text-center">
        ...
        <h3 className="text-sm font-semibold text-text-primary mb-1">Chưa có phiếu xuất nào</h3>
        <p className="text-xs text-text-secondary">Các phiếu xuất kho sẽ được hiển thị tại đây</p>
      </div>
    </div>
  );
}
