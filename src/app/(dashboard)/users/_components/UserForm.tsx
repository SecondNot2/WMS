      ...
      <div className="lg:col-span-8 space-y-6">
        <div className="bg-card-white rounded-xl border border-border-ui shadow-sm p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="space-y-1.5">
              <label className="text-[12px] font-semibold text-text-secondary">
                Mật khẩu {isEdit ? "mới" : "mặc định"}
              </label>
              <input
                type="password"
                {...register("password")}
                placeholder={
                  isEdit ? "Bỏ trống nếu không đổi" : "Nhập mật khẩu mặc định"
                }
                className="w-full px-3 py-2 text-sm bg-background-app/50 border border-border-ui rounded-lg outline-none focus:border-accent transition-colors"
              />
            </div>
        ...
        <div className="bg-card-white rounded-xl border border-border-ui shadow-sm p-6">
          <h3 className="text-sm font-semibold text-text-primary mb-5 flex items-center gap-2">
            <Shield className="w-5 h-5 text-accent" /> Quyền theo vai trò
          </h3>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="p-4 rounded-xl border border-border-ui bg-background-app/50">
              <p className="text-xs font-bold text-text-primary">Admin</p>
              <p className="text-[11px] text-text-secondary mt-1">
                Toàn quyền hệ thống, duyệt phiếu, quản lý user.
              </p>
            </div>
            <div className="p-4 rounded-xl border border-border-ui bg-background-app/50">
              <p className="text-xs font-bold text-text-primary">Thủ kho</p>
              <p className="text-[11px] text-text-secondary mt-1">
                Quản lý sản phẩm, lập phiếu nhập/xuất, xem tồn kho.
              </p>
            </div>
            <div className="p-4 rounded-xl border border-border-ui bg-background-app/50">
              <p className="text-xs font-bold text-text-primary">Kế toán</p>
              <p className="text-[11px] text-text-secondary mt-1">
                Xem báo cáo, xuất dữ liệu, tra cứu sản phẩm.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="space-y-3">
            ...
            <div className="flex items-start gap-3 p-3 rounded-lg bg-background-app/50 border border-border-ui">
              ...
              <p className="text-[11px] text-text-secondary">
                ...
                Yêu cầu đổi mật khẩu ở lần đăng nhập đầu tiên khi backend hỗ
                trợ.
              </p>
            </div>
            <div className="flex items-start gap-3 p-3 rounded-lg bg-background-app/50 border border-border-ui">
