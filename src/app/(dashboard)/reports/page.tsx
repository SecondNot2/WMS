...
const reportModules = [
  {
    ...
    description:
      "Phân tích lưu lượng hàng hóa luân chuyển qua kho theo thời gian thực hoặc định kỳ.",
  ...
  },
  {
    ...
    description:
      "Thống kê chính xác số lượng và giá trị tài sản đang lưu kho tại một thời điểm cụ thể.",
  ...
  },
  {
    ...
    description:
      "Top các sản phẩm có tốc độ luân chuyển nhanh hoặc chậm nhất trong kho.",
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {reportModules.map((report) => (
          ...
          >
            <div
              className={cn(
                "w-12 h-12 rounded-xl flex items-center justify-center mb-5 transition-transform group-hover:scale-110 duration-300",
                report.bg,
                report.color,
              )}
            >
      ...
      <div className="bg-accent/5 border border-accent/20 rounded-2xl p-6 flex gap-4 items-start">
        ...
        <div>
          ...
          <p className="text-sm text-text-secondary mt-1">
            Bạn có thể xuất tất cả các báo cáo ra định dạng{" "}
            <strong>Excel (.xlsx)</strong> hoặc <strong>PDF</strong> để phục vụ
            lưu trữ vật lý hoặc gửi cho các bên liên quan.
          </p>
        </div>
      </div>
    </div>
